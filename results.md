...
**Käytetyt funktiot:** *[IF](functions.md#if) [RANK](https://github.com/Pentu88/PilkkiCUP/blob/main/functions.md#rank) [COUNTIF](functions.md#countif) [COUNTIFS](functions.md#countifs)*
